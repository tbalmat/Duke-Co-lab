#####################################################################################################
# Duke University Co-lab Shiny Workshop, Session 4, November 2020
...
# Local
setwd("C:/Projects/Duke/Co-lab/Shiny-Fall-2020")
# Rstudio Cloud dir
#setwd("/cloud/project/Duke-Co-lab/Shiny")

# Import flight evaluation functions
source("Session-4-plotly/App/FlightMap/FlightEvaluation-plotly-Functions.r", echo=F, local=T)
