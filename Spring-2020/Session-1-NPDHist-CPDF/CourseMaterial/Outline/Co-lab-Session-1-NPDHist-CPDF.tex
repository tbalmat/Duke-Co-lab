...
\begin{itemize}
  ...
  \item Workshop materials:  \url{https://rstudio.cloud/project/1062429}
...
Workshop files in \url{https://rstudio.cloud/project/1062429}, subdirectory \\ \texttt{Duke-Co-lab/Shiny/Session-1-NPDHist-CPDF/App/CPDF/ShellExecution/CPDF-Shiny-1}.  These implement the CPDF R analysis in Shiny.  Figure \ref{fg:CPDF-Shiny-1} is an example screen-shot of the x-y tab.  Figure \ref{fg:CPDF-Shiny-2} is an example screen-shot of the distribution tab. 
...
Workshop files in \url{https://rstudio.cloud/project/1062429}, subdirectory \\ \texttt{Duke-Co-lab/Shiny/Session-1-NPDHist-CPDF/App/NavPage}.
