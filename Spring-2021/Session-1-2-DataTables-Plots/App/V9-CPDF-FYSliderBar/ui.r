        ...
        tabPanel("x-y Plots",
          ...
          column(width=8,
            ...
            fluidRow(width=12,
                     #HTML("<center>"),
                     column(width=12,
                            plotOutput("t1Plot", width="800px", height="800px"),
        ...
        tabPanel("Employee Distribution Plots",
          ...
          column(width=8,
            ...
            fluidRow(width=12,
                     #HTML("<center>"),
                     column(width=12,
                            plotOutput("t2Plot", width="800px", height="800px"),
                            # Display FY slider bar only when independent var (x-axis) is not FY
                            # This will be used to subset the data for animated FY change analysis
                            conditionalPanel(condition="input.t2IndepVar!='fy'",
                                             sliderInput("t2PlotSlider", "", min=1988, max=2011, step=1, value=1988,
                                                         width="600px", sep="",
                                                         animate=animationOptions(playButton=HTML("<br><b>play</b>"), interval=500)))
                     ),
                     HTML("</center>")
